...
describe 'Validations' do
  ...
  describe "Hydra::PCDM" do
    ...
    describe "#file?" do
      it "should return false for a works collection" do
        expect( Hydra::PCDM.file? works_coll ).to be false
      end

      it "should return false for a works generic work" do
        expect( Hydra::PCDM.file? works_gwork ).to be false
      end

      it "should return false for a works generic file" do
        expect( Hydra::PCDM.file? works_gfile ).to be false
      end

      it "should return false for a pcdm collection" do
        expect( Hydra::PCDM.file? pcdm_coll ).to be false
      end

      it "should return false for a pcdm object" do
        expect( Hydra::PCDM.file? pcdm_obj ).to be false
      end

      xit "should return true for a pcdm file" do
        # TODO Should a pcdm file pass the file? test?
        expect( Hydra::PCDM.file? pcdm_file ).to be true
      end
    end
  end
