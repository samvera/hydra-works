module Hydra::Works
  class AddGenericFileToGenericWork
    ...
    def self.call( parent_generic_work, child_generic_file )
      warn "[DEPRECATION] `Hydra::Works::AddGenericFileToGenericWork` is deprecated.  Please use syntax `parent_generic_work.generic_files << child_generic_file` instead.  This has a target date for removal of 07-31-2015"
      parent_generic_work.generic_files << child_generic_file
    end
  end
end
